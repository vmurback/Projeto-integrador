package br.com.generation.los4hermanos.lotus.configuration;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("br.com.generation.los4hermanos.lotus.controller"))
    ...
    private static Contact contact() {
        return new Contact("Vitor Murback", "https://github.com/vmurback", "vitormurback@outlook.com");
    }
